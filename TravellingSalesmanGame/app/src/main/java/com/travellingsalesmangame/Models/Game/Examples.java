...
public class Examples {
    ...
    static {
        ...
        cores = new Core[][]{
                ...
                new Core[]{
                        new Core(new int[]{4, 1, 13, 15, 25, 29, 33},new int[][]{{4,1,35},{4,13,30},{4,15,30},{4,25,37},{4,29,35},{4,33,20},{1,13,25},{1,15,25},{1,25,40},{1,29,25},{1,33,30},{13,15,29},{13,25,35},{13,29,20},{13,33,25},{15,25,25},{15,29,25},{15,33,25},{25,29,25},{25,33,25},{29,33,25}},135),
